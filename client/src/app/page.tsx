...
export default function Home() {
  return (
    <>
      <MaxWidthWrapper className="mt-28 mb-12 sm:mt-40 flex flex-col items-center justify-center">
        <div className="mx-auto mb-4 flex max-w-fit items-center justify-center space-x-2 overflow-hidden rounded-full border border-gray-200 bg-white px-7 py-2 shadow-md backdrop-blur transition-all hover:border-gray-300 hover:bg-white/50 hover:cursor-pointer">
          <p className="text-sm font-semibold text-black">SwiftPDF</p>
        </div>

        <div className="text-center">
          <h1 className="max-w-4xl text-5xl font-bold md:text-6xl lg:text-7xl">
            Chat with your <span className="text-blue-700">document</span> in
            seconds.
          </h1>

          <p className="mt-5 text-zinc-700 sm:text-lg">
            SwiftPDF allows you to have conversations with any PDF document.{" "}
            <br />
